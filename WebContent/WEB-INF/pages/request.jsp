...
<script>
/* $("#datetimepicker1").bind('mouseover', function() {
	  setTimeout(function() {
	     $("#datetimepicker1").unbind('mouseover');
	    $("#datetimepicker1").fadeIn(500);
	  }, 500);
...
if (userSource == 1 && trackCredit == 'N'){
		...
		/*   $(window).keydown(function(event){
		  ...
		  $('#contact-form').find('input').keypress(function(e){
									...
									<div class="row">
											...
											<div class="newRequestWhite">
												...
												<div class="descForm">
													<label>Request Title</label> <span class="alertF"
														id="querytitleAlert" style="display: none">Please enter the title of the request.</span>
													<form:input class="formControl minH45" type="text"
														id="querytitle" path="queryTitle"
														value="${query.queryTitle}"></form:input>
												</div>

												<div class="descForm">
													<label>Description</label> <span class="alertF"
														id="queryDescAlert" style="display: none">Please enter the description of the request.</span>
													<form:textarea type="text" path="queryContent"
														value="${query.queryContent}" id="queryDesc"
														class="formControl minH65"></form:textarea>
												</div>
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
											<div class="newRequestRight">
												<p>
													<strong>It's best to put something specific and
											...
											<div class="newRequestWhite">
												...
												<div class="descForm choosC">
													<span class="alertF" id="categoriesAlert"
														style="display: none">Please select at least one category.</span> 
														<label>Request Categories: <span>Select
															one or more.</span></label>
													<div id="the-basics">
														<input class="typeahead formControl" type="text"
															placeholder="Search" id="smart_search">
													</div>
											...
											<div class="newRequestRight">
												<p>
													<strong>Search or select the most precise category
														related to your request, so that it is matched with the
														best Fixer.</strong>
												</p>
											</div>
										</div>
												...
												<div id="attach">
													...
													<c:forEach var="documents" items="${documents}">
														...
														<div class="download" id="${documents.fileUniqueCode}">
															<span>Download:</span> <a href= "${documents.fileUrl}"><input type="text"
																name="documents" value="${documents.fileName}" readonly></a>
															<i data-icon="y" class="icon" onclick = "deleteFileCopyRequest('${documents.fileUniqueCode}')" > </i>
														</div>
													</c:forEach>
											...
											<div class="newRequestWhite">
												...
												<div class="estimateH" style="min-height: 78px;">
													<div class="addH" style="margin: 0px;">
														<span class="alertF" id="hoursAlert" style="display: none">Please enter the title of the request.</span> <img
															...
															value="1" type="number" onchange="addhoursOnchange(this.value)" name="queryCredits" id="hours"
															> <img
															src="${pageContext.request.contextPath}/images/moreA.png"
															alt="" id="rightimg"
												...
												<div class="descForm">
													<label class="width100w">Desired due date and time:</label> <input
											...
											<div class="newRequestWhite">
												...
												<div class="estimateH">
													...
													<span class="alertF" id="leaverequestAlert"
														style="display: none">Please select at least one Fixer for the request.</span>
													...
													<div class="radio" id="SendSpecificFixer"
														onchange="sendSpecificFixerClick('')">
												...
												<input placeholder="" name="fixerId" value="424"
													...
													<div class="filterA">
														...
														<div class="descForm">
															<label>Search Name</label> <input type="search"
																...
																class="formControl"
																onkeyup="searchNameChanged(this.value)">
														</div>
													</div>
													<!-- // 1 // -->
												...
												<div class="findFixBtn">
													<div class="row">
														<div
															...
															<button type="button" class="clear" id="clearButton"
																onclick="clearBtnClick()">Clear</button>
														</div>
														<div
															class="col-lg-6 col-md-6 col-sm-6 col-xs-12 nopadding">
															<button type="button" id="submitBtnImpl"
																onclick="validationCheck(${points})" class="SRequest">Submit
																Request</button>
														</div>
													</div>
												</div>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-body">
											<h1 class="h1-underline width300">Choose Categories</h1>
