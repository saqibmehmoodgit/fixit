            ...
            <div class="row">
               ...
               <div class="col-md-10">
				  ...
				  <h2 class="QueryTitle fontsize35">1.Query Title: ${query.queryTitle}</h2>
				   ...
				   <span class="more">${query.queryContent}</span>
				   <br></div>
               ...
               <div class="col-md-10 col-sm-10 col-sm-12">
                  <div class="notimessagetxt">
                     ...
                     <div class="row">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/favorInFixer?queryId=${query.hashcode}" style="margin-top:15px; margin-right:20px; width:270px;" class="btn btn-info">Resolve in favor of fixer</a>
                           <!-- <button type="button" style="margin-top:15px" class="btn btn-info btn-lg  btn-block">Resolve in favour of fixer</button> -->
                        <a href="${pageContext.request.contextPath}/admin/favorInMember?queryId=${query.hashcode}" style="margin-top:15px; width:270px;" class="btn btn-warning">Resolve in favor of Member</a>
                        </div>
