...
<script>
    ...
    <section class="member">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="animated fadeInDown">Un Claimed</h1>
                        ...
                        <div id="UnClaimed" class="tab-pane fade in active">
                            ...
                            <div class="unclaimedR">
                                <div class="uclaimedcell">
                                    ...
                                    <h2><a href="../admin/editQuestion?queryId=${queryDetail.hashcode}&status=notSure">${queryDetail.queryTitle}</a>
								<span class="postAgo">Posted: ${queryDetail.timeDiff} ago. </span>
                                    ...
                                    <div class="unclatbn">
                                            <c:forEach var="subCategory" items="${queryDetail.subCategory}">
                                             <a href="#" class="btn btn-primary"> ${subCategory}</a>
                                             </c:forEach>

                                   </div>
                                </div>
                                <div class="uclaimedcell">
                                    <a href="../admin/editQuestion?queryId=${queryDetail.hashcode}&status=notSure" class="uclaibtn" style="width:200px;">Edit</a>
          ...
          <h4 class="modal-title">Are you sure to delete?</h4>
                                                                        ...
                                                                        <div class="modal-body" style="text-align:center; min-height:160px;">
                                                                            ...
                                                                            <a href="../member/delete?queryId=${queryList.hashcode}" class="btn btn-info width100">OK</a>
