		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					...
					<h2  class="fontsize35" style="text-align:center;"> Mail to All Members</h2>
					</c:if>
					<c:if test="${userType=='F'}">
					<h2  class="fontsize35" style="text-align:center;"> Mail to All Fixers</h2>
					</c:if>
								...
								<div class="row">
									...
									<h2>Subject</h2>
										<div class="form-group" style="margin-top: 10px">
											<textarea class="form-control solutionsbox solutionsbox1" placeholder="Type here.." id="myTextareaSubject" ></textarea>
...
<!-- 
									...
									<!-- 		<button style="top:42px;"   class="upload uploadFile" id="uploadFileIcon"><i id="uploadIcon" class="fa fa-paperclip"></i></button> -->
										...
										<div class="row">
											...
											<div>
												<button type="button" class="btn btn-success  btn-block"  style="padding: 5px 40px; width : 30%;font-size: 23px; margin-top:10px; margin-left : 35%;" onclick="sendButtonClicked()" id="sendMessageButton">Send Message</button>
											</div>
										</div>
										...
										<div class="chatdiv">
											...
											<c:forEach var="message" items="${messagesSet}">
													...
													${message.chatMessage}
                 														 ...
                 														 <c:otherwise>
                     <div class="crow1">
														<img src='${otherUserImgIcon}' onerror="if (this.src != '../images/default_profile.jpg') this.src ='../images/default_profile.jpg';">
													${otherUserName}	${message.createdAt} <br>
														<p>
															${message.chatMessage}
															</p>
													</div>
   ...
   <!--       <div class="col-md-6 col-sm-6">
	...
	function sendButtonClicked(){
		...
		var msgSubject=document.getElementById( 'myTextareaSubject' ).value;
		var userType= '${userType}';
		if(msg.length<=0 || msgSubject.length <=0){
		...
		$.ajax({
			method : "POST",
		    url : "../admin/sendEmailToUsers",
		    data : {
		    	message : document.getElementById( 'myTextarea' ).value,
		    	subject : document.getElementById( 'myTextareaSubject' ).value,
		    	userType : userType
