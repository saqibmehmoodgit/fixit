	...
	<section class="member-settins1">
		<div class="container">
			<div class="row">
				...
				<h1 class="animated fadeInDown">Admin Settings 
		...
		<div class="container">
         ...
         <strong>Success!</strong>   ${userUpdate}
					...
					<form:form method="POST"
								action="${pageContext.request.contextPath}/admin/updateAdminSettings"
					...
					<form:input class="form-control" type="text" path="city"
						...
						<button type="submit" class="btn btn-primary btn-block"><i class="fa fa-check-circle" ></i> Update Admin Profile</button>
					</form:form>
					</div>
				...
				<div class="graybg">
					<form:form method="POST"
								action="${pageContext.request.contextPath}/admin/saveNewPassword"
