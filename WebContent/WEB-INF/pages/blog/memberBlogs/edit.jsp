...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/typeahead.bundle.js"></script>
...
<script
	src="${pageContext.request.contextPath}/editor/samples/js/sample.js"></script>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-sm-8">
					<h1 class="animated fadeInDown">Add your Blog here*</h1>
					<div class="graybg">
						<form:form method="POST" action="updateBlog"
							modelAttribute="blogBo" commandName="blogBo" id="submit_form">
							<h2>
								<span>1.</span> Add Blog title.
							</h2>
							...
							<div class="adjoined-bottom">
								<div class="grid-container">
									<div class="grid-width-100">
										...
										<textarea id="editor" name="blogDescription"
											required="required">${blogList.blogDescription }</textarea>
										<div id="preview"></div>
									</div>
								</div>
							</div>
							<input type="hidden" name="id" value="${blogList.blogId }" /> </main>
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6" style="visiblity: hidden;">
									<button type="submit" class="btn btn-primary btn-block"
										id="publish" name="button" value="Publish">
										<i class="fa fa-upload"></i> Publish
									</button>
									<button type="button" class="btn btn-primary btn-block btnNone"
										id="publishType" name="button">
										<i class="fa fa-upload"></i> Publish
									</button>
								</div>
							</div>
