		...
		<div class="container">
				...
				<div class="col-md-10 col-sm-10">
					<div class="blogmain">
						...
						<div class="btnBlog">
								...
								<c:if test="${blogList.blogStatus == 'draft' }">
								       <a href="publishBlog?blogId=${blogList.blogId }" class="btn btn-warning"><i class="fa fa-upload"></i> Publish</a>
								</c:if>  
								...
								<a href="deleteBlog?blogId=${blogList.blogId}" class="btn btn-danger"><i class="fa fa-times"></i> Delete</a>
							...
							<div class="blogBox">
								...
								<c:if test="${status == 'declined'}">
									  <span class="text-danger dec">Reason:- ${blogList.reason}</span>
							    </c:if>  
         ...
         <c:choose>
          ...
          <c:otherwise>
           <c:choose>
            ...
            <c:otherwise>
             <li><a
              href="../fixer/blogList?pageNo=${currentPageNo}&flag=left"
         ...
         <c:forEach begin="${startPage}" end="${endPage}" varStatus="p">
          <c:choose>
           ...
           <c:otherwise>
            <li><a
             href="../fixer/blogList?pageNo=${p.index}&flag=current">${p.index}</a></li>
           </c:otherwise>
          </c:choose>
         ...
         <c:choose>
          ...
          <c:otherwise>
           <c:choose>
            ...
            <c:otherwise>
             <li><a
              href="../fixer/blogList?pageNo=${currentPageNo}&flag=right"
