...
<!-- 
									...
									<div class="col-md-6 col-sm-6">
										<div class="chatdiv">
											...
											<div class="chatbox">
											<div class="chat">
											<c:forEach var="message" items="${messagesSet}"><c:choose>
													...
													${message.chatMessage}
                 														 ...
                 														 <c:otherwise>
                     <div class="crow1">
														<img src='${message.user.profileIcon}' onerror="if (this.src != '../images/default_profile.jpg') this.src ='../images/default_profile.jpg';">
