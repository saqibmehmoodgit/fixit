...
public interface QueryDao extends JpaDao<Query> {
	 ...
	 *            - query Id of a query.
	 *  @param currentStatus
	 *            - currentStatus  of a query to be changed.
	 * @return Integer
	 * 			- update status.
	 */
	 ...
	 * @return Set of object of Query.
	 */
	public List<Query> findQueryClosed(int userId,Calendar startDate , Calendar endDate, int startResult, int max) throws DataAccessException;
