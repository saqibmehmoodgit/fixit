		...
		<div class="container">
         ...
         <strong>Success!</strong>   ${userUpdate}
					...
					<form:form method="POST"
								action="${pageContext.request.contextPath}/member/updateMemberSettings"
					...
					<form:input class="form-control" type="text" path="city"
					  ...
					  <form:options items="${timeZoneList}" />
						...
						<button type="submit" class="btn btn-primary btn-block"><i class="fa fa-check-circle" ></i> Update User Profile</button>
					</form:form>
					</div>
				...
				<div class="col-md-5 col-sm-5">
					<div class="graybg">
					  <form:form method="POST"
								action="${pageContext.request.contextPath}/member/updateMemberAlert"
								modelAttribute="memberAlert" commandName="memberAlert">
						<h2>My Alerts</h2>
						...
						<div class="" style="height:40px; width:100%; clear:both;">
							...
							<input type="hidden"  name ="emailAlert"  value="${memberAlert.emailAlert}"  id="emailAlert_id" >
							<c:choose>
							<c:when  test="${memberAlert.emailAlert=='Y'}">
						...
						<!-- <h3>SMS Alerts 
						<span class="switcher"><input checked data-toggle="toggle" data-style="ios" type="checkbox"></span>
						</h3>
						<fieldset>
					...
					<div class="graybg">
					<form:form method="POST"
								action="${pageContext.request.contextPath}/member/saveNewPassword"
