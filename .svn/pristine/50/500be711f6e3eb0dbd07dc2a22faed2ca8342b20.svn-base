		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="UnClaimed" class="tab-pane fade in active">
				  ...
				  <div class="unclaimedR">
						           ...
						           <div class="uclaimedcell">
                                    <div class="unclatbn text-right">
										...
										class="fa fa-arrow-circle-o-down"></i> Download</a>
                                         ...
                                         <a href="" class="btn btn-info" data-toggle="modal" data-target="#myModal6"><i class="fa fa-level-down"></i> Decline</a>
                                   <a href="../fixer/claim/?queryId=${queryDetail.queryId}" class="btn btn-warning"><i class="fa fa-suitcase"></i> Claim</a>
						...
						<div class="uclaimedcell">
                                   <%--  <a href="" class="uclaibtn" data-toggle="modal" data-target="#myModal6"><i class="fa fa-level-down"></i> Decline</a>
                                   <a href="../fixer/claim/?queryId=${queryDetail.queryId}" class="uclaibtn1"><i class="fa fa-suitcase"></i> Claim</a> --%>
          ...
          <h4 class="modal-title">Are you sure to Reject Fixer?</h4>
                                                        ...
                                                        <div class="modal-body" style="text-align:center;min-height:160px;">
                                                            <h2 class="text-center">Are you sure want to decline?</h2>
                                                            <a href="../fixer/decline/?queryId=${queryDetail.queryId}" class="btn btn-info width100" style="font-size: 25px;
